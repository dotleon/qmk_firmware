/* Copyright 2019 dotleontttttttttttttttttttttttttttttttttttttttttttt
 *
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_LCTL,KC_LCMD,KC_LALT,KC_NO  ,KC_NO  ,KC_SPC ,KC_NO  ,

                                                  KC_F6  ,KC_F7  ,KC_F8  ,KC_F9  ,KC_F10 ,KC_F11 ,KC_F12 ,
    KC_NLCK,KC_PSLS,KC_PAST,KC_PMNS,              C(HU_Y),HU_6   ,HU_7   ,HU_8   ,HU_9   ,_______,KC_BSPC,
    KC_P7  ,KC_P8  ,KC_P9  ,KC_PPLS,              HU_UU  ,HU_Z   ,HU_U   ,HU_I   ,HU_O   ,HU_P   ,KC_DEL ,
    KC_P4  ,KC_P5  ,KC_P6  ,KC_PENT,              HU_OO  ,HU_H   ,HU_J   ,HU_K   ,HU_L   ,HU_OE  ,KC_ENT ,
    KC_P1  ,KC_P2  ,KC_P3  ,KC_UP  ,              HU_OEE ,HU_N   ,HU_M   ,HU_COMM,HU_DOT ,HU_UE  ,HU_UEE ,
    KC_P0  ,KC_PDOT,KC_LEFT,KC_DOWN,KC_RGHT,      KC_NO  ,MO(_R) ,KC_NO  ,KC_HOME,KC_PGUP,KC_PGDN,KC_END
    ),
    [_R] = LAYOUT(
    ...
    BL_OFF ,BL_DEC ,Y_TBRTH,_______,_______,      _______,_______,_______,_______,_______,_______,_______
    )
    // [_RAISE] = LAYOUT(
    // _______,_______,_______,_______,_______,_______,_______,
    // _______,_______,_______,_______,_______,_______,_______,
