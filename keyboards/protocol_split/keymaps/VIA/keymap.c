...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_P0  ,KC_PDOT,KC_LEFT,KC_DOWN,KC_RGHT,      KC_NO  ,MO(1) ,KC_NO  ,KC_HOME,KC_PGUP,KC_PGDN,KC_END
    ),
    [1] = LAYOUT(
    ...
    BL_OFF ,BL_DEC ,_______,_______,_______,      _______,_______,_______,_______,_______,_______,_______
    )
    // [_RAISE] = LAYOUT(
    // _______,_______,_______,_______,_______,_______,_______,
    // _______,_______,_______,_______,_______,_______,_______,
