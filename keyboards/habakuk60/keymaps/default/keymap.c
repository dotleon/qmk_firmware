...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  { \
    ...
    { KC_LCTL,KC_LCMD,KC_LALT,MO(5)  ,MO(5)  ,KC_SPC ,        OSL(1) ,TT(2)  ,KC_LEFT,KC_UP  ,KC_DOWN,KC_RGHT }  \
  },
  ...
  //5 navigation, settings and reset
  { \
    { RESET  ,MU_TOG ,MU_MOD ,CK_TOGG,CK_RST ,CK_UP  ,        KC_NO  ,KC_NO  ,KC_NO  ,KC_NO  ,KC_NO  ,TG(4)   }, \
    { DEBUG  ,AU_TOG ,MUV_DE ,MUV_IN ,KC_NO  ,CK_DOWN,        KC_PGUP,KC_HOME,KC_UP  ,KC_END ,KC_NO  ,_______ }, \
    { TG(3)  ,_______,_______,_______,_______,_______,        KC_PGDN,KC_LEFT,KC_DOWN,KC_RGHT,KC_NO  ,_______ }, \
